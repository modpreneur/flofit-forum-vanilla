...
if ($this->Data('Comments')->NumRows() > 0)
	echo '<div class="ncwrap"><div class="nocommentwrap"><i class="fa fa-comments oil"></i></div></div><div class="sja">'.$this->Data('_CommentsHeader', T('Comments')).'</div><div class="clearleft"></div>';
?>
<?php
if ($this->Data('Comments')->NumRows() == 0)
	echo '<div class="ncwrap"><div class="nocommentwrap"><i class="fa fa-comments oil"></i></div></div><div class="sja">'.$this->Data('_CommentsHeader', T('No Comment')).'</div><div class="clearleft"></div>';
?>

<ul class="MessageList DataList Comments">
	<li class="iopo"></li><?php include $this->FetchViewLocation('comments'); ?>
</ul>
<?php
