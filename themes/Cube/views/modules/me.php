...
if ($Session->IsValid()):
   ...
   echo '<div class="WhoIs">';
      echo userCustomProfilePhotoElement($username);
      ...
      echo '<div class="MeMenu">';
         ...
         echo Anchor(Sprite('steampackone-flash', '').Wrap(T('Notifications'), 'em').$CNotifications, UserUrl($User), 'MeButton FlyoutButton', array('title' => T('Notifications')));
         ...
         if (Gdn::ApplicationManager()->CheckApplication('Conversations')) {
            ...
            echo Anchor(Sprite('steampackone-mail', '').Wrap(T('Inbox'), 'em').$CInbox, '/messages/all', 'MeButton FlyoutButton', array('title' => T('Inbox')));
            echo Sprite('SpFlyoutHandle', 'Arrow');
            echo '<div class="Flyout FlyoutMenu"></div></span>';
         }
         ...
         if (Gdn::ApplicationManager()->CheckApplication('Vanilla')) {
            ...
            echo Anchor(Sprite('steampackone-star', '').Wrap(T('Bookmarks'), 'em'), '/discussions/bookmarked', 'MeButton FlyoutButton', array('title' => T('Bookmarks')));
            echo Sprite('SpFlyoutHandle', 'Arrow');
            echo '<div class="Flyout FlyoutMenu"></div></span>';
         }
         ...
         //echo Anchor(Sprite('steampackone-wrench', '').Wrap(T('Account Options'), 'em').$CDashboard, '/profile/edit', 'MeButton FlyoutButton', array('title' => T('Account Options')));
         echo Sprite('SpFlyoutHandle', 'Arrow');
